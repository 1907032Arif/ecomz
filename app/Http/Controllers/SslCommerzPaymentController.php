...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleEasyCheckout()
    {
        ...
        $productsInCart = Cart::all();

        return view('sslcommerz.exampleEasycheckout', compact('cartProducts', 'productsInCart'));
    }
    ...
    public function exampleHostedCheckout()
    {
        ...
        return view('sslcommerz.exampleHosted', compact('cartProducts', 'rowCount'));
    }
